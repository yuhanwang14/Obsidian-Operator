---
name: weekly-review
description: "TRIGGER IMMEDIATELY for /weekly-review, or when the user asks to review their week, generate a weekly synthesis, score intentions, or detect stalled/horizon items. Produces a weekly review note with progress, stalls, scorecards, and next-week focus. NOT for weekly init/planning."
---
